...
def math_reward_function(prompt: str, response: str, expected_answer: str = None) -> float:
    ...
    # print('comparing', predicted_answer, expected_answer)
    ...
    if expected_answer is not None and predicted_answer:
        is_correct = compare_answers(predicted_answer, expected_answer)
        return 1.0 if is_correct else 0.0
    
    # Return 0.0 for missing expected answers (problems removed by flip_label.py)
    return 0.0
