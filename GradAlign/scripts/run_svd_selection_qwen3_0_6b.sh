...
# Qwen3-0.6B: per-prompt SVD effective-rank selection + GRPO training.
# Model/data/runtime defaults match the existing GradAlign cosine script.
...
PREFIX="${PREFIX:-svd_erank_qwen3_0_6b_unified_reward_v1}"
